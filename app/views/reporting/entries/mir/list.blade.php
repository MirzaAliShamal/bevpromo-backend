    ...
    <div class="page-content">
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-users"></i>Mail-in-Rebate Entries
                </div>
            </div>
            <!-- END PAGE HEADER-->
            <!-- BEGIN PAGE CONTENT-->
            <div class="portlet-body form">
                ...
                <div class="row col-md-12 " id="filter-bar-bottom">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" data-source="{{ URL::to('mir_entry_client_source') }}" data-grid="standard">
                                    ...
                                    <tr>
                                        ...
                                        <th class="sortable col-md-1" data-grid="standard" data-sort="dollar_value">Coupon Value</th>
                    ...
                    @include('templates/reporting/entries/mir/results')
                    @include('templates/reporting/entries/mir/no_results')
                    @include('templates/reporting/entries/mir/pagination')
                    @include('templates/reporting/entries/mir/filters')
                    @include('templates/reporting/entries/mir/no_filters')
                </div>
            </div>
        </div>
        <!-- END PAGE CONTENT-->
