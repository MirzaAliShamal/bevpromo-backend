...
<div class="content">
    ...
    {{ Form::open(['route'=>'login.store', 'class'=>'login-form']) }}
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                {{ Form::text('email', null, ['class'=>'form-control placeholder-no-fix', 'autocomplete'=>'off', 'placeholder'=>'Email Address:']) }}
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-actions">
            ...
            {{ Form::button('Login <i class="m-icon-swapright m-icon-white"></i>', ['type' => 'submit', 'class' => 'btn blue pull-right']) }}
        </div>
    {{ Form::close() }}
    <!-- END LOGIN FORM -->
</div>
