            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="portlet box blue-hoki ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-reorder"></i> Add New IRC Coupon
                        </div>
                    ...
                    <div class="portlet-body">
                        {{ Form::open(['route'=>['admin.coupons.irc.store'], 'class'=>'form-horizontal', 'role'=>'form', 'id'=>'update-form', 'method' => 'post', 'autocomplete'=>'off']) }}
...
{{--                                    {{ Form::date('receive_by', null, ['class'=>'form-control form-control-inline input-medium date-picker', 'autocomplete'=>'off']) }}--}}
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <a href="/admin/clients/create?inline=1" target="_blank" class="btn red control-label"
                            ...
                            <div class="form-group">
                                ...
                                <a href="/admin/brands/create?inline=1" target="_blank" class="btn red control-label"
                                    role="button" style="text-align: center;"><i class="fa fa-plus"></i></a>&nbsp;
