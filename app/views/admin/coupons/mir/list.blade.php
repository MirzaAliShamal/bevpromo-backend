    ...
    <div class="page-content">
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-users"></i>Mail-In-Rebate Programs
                </div>
                            ...
                            <table class="table table-striped table-bordered table-hover"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sortable col-md-1" data-grid="standard" data-sort="user">Program Owner</th>
...
<script>
    $(document).on('click', '.btndelt', function () {
        ...
        if (r == true) {
            ...
            var url = "/admin/coupons/mir/delete";
