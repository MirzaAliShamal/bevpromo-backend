            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="portlet box blue-hoki ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-reorder"></i> Edit Administrator
                        </div>
                        ...
                        <a href="/reset/{{ $user->id }}" class="btn blue-hoki pull-right" role="button">Reset User's Password <i class="fa fa-lock"></i></a>
                    </div>
                    <div class="portlet-body">
                        {{ Form::open(['route'=>['admin.admins.update', $user->id], 'class'=>'form-horizontal', 'role'=>'form', 'id'=>'update-form', 'method' => 'put']) }}
                        <div class="form-body">
