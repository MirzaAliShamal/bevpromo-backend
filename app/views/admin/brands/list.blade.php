    ...
    <div class="page-content">
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-users"></i>Click on a Brand to Edit
                </div>
                <a href="/admin/brands/create" class="btn red pull-right" role="button">Add New Brand <i class="fa fa-plus"></i></a>
            </div>
            <!-- END PAGE HEADER-->
            <!-- BEGIN PAGE CONTENT-->
            <div class="portlet-body form">
                ...
                <div class="row col-md-12 " id="filter-bar-bottom">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" data-source="{{ URL::to('brands_source') }}" data-grid="standard">

                                    <thead>
                                    <tr>
                                        <th class="sortable col-md-1" data-grid="standard" data-sort="id">ID</th>
                                        <th class="sortable col-md-2" data-grid="standard" data-sort="name">Brand Name</th>
                                        <th class="sortable col-md-2" data-grid="standard" data-sort="supplier">Supplier</th>
                                        <th class="sortable col-md-2" data-grid="standard" data-sort="irc_active">IRC Enabled</th>
                                        <th class="sortable col-md-2" data-grid="standard" data-sort="mir_active">MIR Enabled</th>
                    ...
                    @include('templates/brands/results')
                    @include('templates/brands/no_results')
                    @include('templates/brands/pagination')
                    @include('templates/brands/filters')
                    @include('templates/brands/no_filters')
                </div>
            </div>
        </div>
        <!-- END PAGE CONTENT-->
