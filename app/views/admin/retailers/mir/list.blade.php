    ...
    <div class="page-content">
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                ...
                <a href="/admin/retailers/mir/create" class="btn red pull-right" role="button">Add New Retailer <i class="fa fa-plus"></i></a>
            </div>
            <!-- END PAGE HEADER-->
            <!-- BEGIN PAGE CONTENT-->
            <div class="portlet-body form">
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" data-source="{{ URL::to('retailers_mir_source') }}" data-grid="standard">
                                    ...
                                    <tr>
                                        ...
                                        <th class="sortable col-md-1" data-grid="standard" data-sort="is_active">Enabled</th>
                    ...
                    @include('.........templates.retailers.mir.results')
                    @include('.........templates.retailers.mir.no_results')
                    @include('.........templates.retailers.mir.pagination')
                    @include('.........templates.retailers.mir.filters')
                    @include('.........templates.retailers.mir.no_filters')
                </div>
            </div>
        </div>
        <!-- END PAGE CONTENT-->
