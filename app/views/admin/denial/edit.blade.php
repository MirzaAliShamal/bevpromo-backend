                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="portlet box blue-hoki ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i> Edit Denial Reasons
                            </div>
                        ...
                        <div class="portlet-body">
                            <form action="/admin/denial/reasons/update/{{$data['id']}}" method="POST" class="form-horizontal" id="update-form">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio-list col-md-10">
                                        <label class="radio-inline">
                                            @if ($data['active'] ==  MirDenialReason::active)
