    ...
    <div class="page-content">
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                ...
                <div class="col-md-2 pull-right">
                    <a href="/admin/invoice/irc/invoice_all" class="btn red" role="button">Invoice All IRC Entries <i class="fa fa-money"></i></a>
                </div>
            </div>
            <!-- END PAGE HEADER-->
            <!-- BEGIN PAGE CONTENT-->
            <div class="portlet-body form">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover" data-source="{{ URL::to('irc_entry_source') }}" data-grid="standard">
                                ...
                                <tr>
                                    ...
                                    <th class="col-md-1" data-grid="standard" ></th>
                                </tr>
                                </thead>
                                <tbody></tbody>
                            </table>
                ...
                @include('templates/entries/irc/results')
