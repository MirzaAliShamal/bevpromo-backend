    ...
    <div class="page-content">
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-users"></i>Click on a Send-To to Edit
                </div>
                <a href="/admin/send-to/create" class="btn red pull-right" role="button">Add New Send-To <i class="fa fa-plus"></i></a>
            </div>
            <!-- END PAGE HEADER-->
            <!-- BEGIN PAGE CONTENT-->
            <div class="portlet-body form">
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" data-source="{{ URL::to('send_to_source') }}" data-grid="standard">

                                    <thead>
                                    <tr>
                                        <th class="sortable col-md-1" data-grid="standard" data-sort="id">ID</th>
                                        <th class="sortable col-md-2" data-grid="standard" data-sort="name">Send-To Name</th>
                                        <th class="sortable col-md-2" data-grid="standard" data-sort="address">Address</th>
                    ...
                    @include('templates/send-to/results')
                    @include('templates/send-to/no_results')
                    @include('templates/send-to/pagination')
                    @include('templates/send-to/filters')
                    @include('templates/send-to/no_filters')
                </div>
            </div>
        </div>
        <!-- END PAGE CONTENT-->
