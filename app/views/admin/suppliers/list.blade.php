    ...
    <div class="page-content">
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-users"></i>Click on a Supplier to Edit
                </div>
                <a href="/admin/suppliers/create" class="btn red pull-right" role="button">Add New Supplier <i class="fa fa-plus"></i></a>
            </div>
            <!-- END PAGE HEADER-->
            <!-- BEGIN PAGE CONTENT-->
            <div class="portlet-body form">
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" data-source="{{ URL::to('suppliers_source') }}" data-grid="standard">

                                    <thead>
                                    <tr>
                                        <th class="sortable col-md-1" data-grid="standard" data-sort="id">ID</th>
                                        <th class="sortable col-md-4" data-grid="standard" data-sort="name">Supplier Name</th>
                                        <th class="sortable col-md-3" data-grid="standard" data-sort="created_at">Created</th>
                                        <th class="sortable col-md-3" data-grid="standard" data-sort="updated_at">Updated</th>
                    ...
                    @include('templates/suppliers/results')
                    @include('templates/suppliers/no_results')
                    @include('templates/suppliers/pagination')
                    @include('templates/suppliers/filters')
                    @include('templates/suppliers/no_filters')
                </div>
            </div>
        </div>
        <!-- END PAGE CONTENT-->
